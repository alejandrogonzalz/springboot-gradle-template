...
public class UserFilterRequest {
  ...
  @Schema(description = "Created date from", example = "2024-01-01T00:00:00Z or 2024-01-01")
  private String createdAtFrom;

  @Schema(description = "Created date to", example = "2024-12-31T23:59:59Z or 2024-01-01")
  private String createdAtTo;

  @Schema(description = "Updated date from", example = "2024-01-01T00:00:00Z or 2024-01-01")
  private String updatedAtFrom;

  @Schema(description = "Updated date to", example = "2024-12-31T23:59:59Z or 2024-01-01")
  private String updatedAtTo;

  @Schema(description = "Last login date from", example = "2024-01-01T00:00:00Z or 2024-01-01")
  private String lastLoginDateFrom;

  @Schema(description = "Last login date to", example = "2024-12-31T23:59:59Z or 2024-01-01")
  ...
  @Schema(description = "Deleted date to", example = "2024-12-31T23:59:59Z or 2024-01-01")
  private String deletedAtTo;
