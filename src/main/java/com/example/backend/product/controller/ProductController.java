 ...
 *
 * <p>Provides endpoints for CRUD operations and product queries.
 * Uses Swagger annotations for API documentation.</p>
 */
@RestController
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<Page<ProductDto>>> getAllProducts(
        ...
        log.info("GET /api/v1/products - page: {}, size: {}, sortBy: {}, sortDir: {}",
    ...
    public ResponseEntity<ApiResponse<ProductDto>> getProductBySku(
            @Parameter(description = "Product SKU", example = "LAP-001", required = true)
