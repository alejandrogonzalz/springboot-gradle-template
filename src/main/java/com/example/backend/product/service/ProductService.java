 ...
 *
 * <p>Implements business rules and coordinates between repository and controller layers. Uses
 * constructor injection via Lombok's @RequiredArgsConstructor for better testability.
 */
@Service
...
public class ProductService {
  ...
  public ProductDto createProduct(ProductDto productDto) {
    ...
    if (productRepository.existsBySku(productDto.getSku())) {
      throw new DuplicateResourceException(
          "Product already exists with sku: " + productDto.getSku());
    }
  ...
  @Transactional
  @CacheEvict(
      value = {PRODUCTS_CACHE, PRODUCT_BY_ID_CACHE},
      allEntries = true)
