 ...
 *
 * <p>Uses Mockito for mocking dependencies and AssertJ for fluent assertions. Demonstrates best
 * practices for unit testing service layer.
 */
...
class ProductServiceTest {
  ...
  void updateProduct_WithValidData_ShouldReturnUpdatedProduct() {
    ...
    ProductDto updatedDto =
        ProductDto.builder().name("Updated Laptop").price(BigDecimal.valueOf(1299.99)).build();
